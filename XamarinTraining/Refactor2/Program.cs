...
namespace Refactor2
{
	public class Program
	{
		...
		public class ApplicationClient
		{
			...
			{
				var serviceManager = new ApplicationServiceManager("https://ft-ductuu138.oraclecloud2.dreamfactory.com/",
					new AppLoadingProgressor(), new AppNetworkDetector(), new JsonParser());
